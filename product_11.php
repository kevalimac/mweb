...
<script>
  fbq('track', 'ViewContent', {
      content_name: 'Limited Time Grocery Combo – Rice 5KG, Atta 5KG, Oil 5L, Salt 1KG & Sugar 1KG',
      content_ids: ['11'],
    ...
    <div class="product-gallery">
        <div class="main-image-container">
            <img id="mainImage" src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_rhct2trhct2trhct.png?v=1774764919" alt="">
            ...
            <div class="thumbnail-list">
                                <div class="thumb-item active" onclick="updateMainImage(this, 'https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_rhct2trhct2trhct.png?v=1774764919')">
                    <img src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_rhct2trhct2trhct.png?v=1774764919" alt="">
                </div>
                            </div>
        </div>
            </div>
    ...
    <div class="product-info-card">
        <h1 class="product-title">Limited Time Grocery Combo – Rice 5KG, Atta 5KG, Oil 5L, Salt 1KG & Sugar 1KG</h1>
    ...
    <!-- Product Description -->
        ...
        <div class="product-desc-content" style="padding: 12px 16px; overflow: hidden; background:#fff; font-size:0.9rem; line-height:1.5;">
            Save more on your monthly groceries with this Limited Time Combo Offer 🎉

This all-in-one combo includes:

🍚 Basmati Rice – 5KG
🌾 Aashirvaad Chakki Atta – 5KG
🛢️ Fortune Sunflower Oil – 5 Litres
🧂 Tata Salt – 1KG
🍬 Sugar – 1KG

Carefully selected essentials ensure quality, taste, and daily convenience. Whether you're stocking up or looking for a budget-friendly deal, this combo gives you maximum value at minimum cost.

💯 Perfect for families, daily use & bulk savings.

🔥 Key Features (Bullet Points)

👉 Complete Monthly Grocery Pack
👉 Includes Rice, Atta, Oil, Salt & Sugar
👉 Trusted Brands & Quality Products
👉 Perfect for Daily Kitchen Needs

...
<script>
  fbq('track', 'ViewContent', {
      content_name: 'Super Saver Grocery Combo – Rice 5KG, Atta 10KG, Sugar 5KG & Refined Oil 5L',
      content_ids: ['9'],
    ...
    <div class="product-gallery">
        <div class="main-image-container">
            <img id="mainImage" src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_7i9cdo7i9cdo7i9c.png?v=1774764921" alt="">
            ...
            <div class="thumbnail-list">
                                <div class="thumb-item active" onclick="updateMainImage(this, 'https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_7i9cdo7i9cdo7i9c.png?v=1774764921')">
                    <img src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_7i9cdo7i9cdo7i9c.png?v=1774764921" alt="">
                </div>
                            </div>
        </div>
            </div>
    ...
    <div class="product-info-card">
        <h1 class="product-title">Super Saver Grocery Combo – Rice 5KG, Atta 10KG, Sugar 5KG & Refined Oil 5L</h1>
    ...
    <!-- Product Description -->
        ...
        <div class="product-desc-content" style="padding: 12px 16px; overflow: hidden; background:#fff; font-size:0.9rem; line-height:1.5;">
            Make your monthly grocery shopping आसान and affordable with this Super Saver Grocery Combo 🛍️
...
🍬 Sugar – 5KG
🛢️ Refined Cooking Oil – 5 Litres

Carefully selected for everyday use, this combo gives you the perfect balance of quality, quantity, and savings.

Whether you're stocking up your kitchen or looking for a budget-friendly deal, this combo is the perfect choice.
...
👉 Bulk Pack – Best Value for Money
👉 Huge Savings Deal

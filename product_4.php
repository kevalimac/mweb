...
<script>
  fbq('track', 'ViewContent', {
      content_name: 'Rasoi Samagri Special Combo – 20KG Atta, 5KG Sugar, 1KG Besan & 5L Mustard Oil',
      content_ids: ['4'],
    ...
    <div class="product-gallery">
        <div class="main-image-container">
            <img id="mainImage" src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_j3ynhoj3ynhoj3yn.png?v=1774764914" alt="">
            ...
            <div class="thumbnail-list">
                                <div class="thumb-item active" onclick="updateMainImage(this, 'https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_j3ynhoj3ynhoj3yn.png?v=1774764914')">
                    <img src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_j3ynhoj3ynhoj3yn.png?v=1774764914" alt="">
                </div>
                            </div>
        </div>
            </div>
    ...
    <div class="product-info-card">
        <h1 class="product-title">Rasoi Samagri Special Combo – 20KG Atta, 5KG Sugar, 1KG Besan & 5L Mustard Oil</h1>
    ...
    <!-- Product Description -->
        ...
        <div class="product-desc-content" style="padding: 12px 16px; overflow: hidden; background:#fff; font-size:0.9rem; line-height:1.5;">
            Bring home the ultimate Rasoi Samagri Special Combo 🛒 designed for every Indian kitchen.

This combo includes all essential cooking ingredients:

🌾 Multigrain Atta – 20KG
🍬 Sugar – 5KG
🌕 Besan (Gram Flour) – 1KG
🛢️ Mustard Oil – 5 Litres

Perfect for daily cooking, this pack ensures quality, nutrition, and huge savings. Whether you're preparing rotis, snacks, or traditional meals, this combo has everything you need.

💯 Ideal for families, bulk grocery buyers & smart savers.

🔥 Key Features (Bullet Points)

👉 Complete Kitchen Essentials Combo
👉 Includes Atta, Sugar, Besan & Mustard Oil
👉 High Quality & Fresh Products
👉 Perfect for Daily Cooking Needs
👉 Bulk Quantity – Best Value for Money

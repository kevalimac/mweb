...
<script>
  fbq('track', 'ViewContent', {
      content_name: '5KG Premium Mix Dry Fruits Combo – Almonds, Cashews, Pistachios, Walnuts & Raisins',
      content_ids: ['6'],
    ...
    <div class="product-gallery">
        <div class="main-image-container">
            <img id="mainImage" src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_9avcrz9avcrz9avc.png?v=1774764871" alt="">
            ...
            <div class="thumbnail-list">
                                <div class="thumb-item active" onclick="updateMainImage(this, 'https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_9avcrz9avcrz9avc.png?v=1774764871')">
                    <img src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_9avcrz9avcrz9avc.png?v=1774764871" alt="">
                </div>
                            </div>
        </div>
            </div>
    ...
    <div class="product-info-card">
        <h1 class="product-title">5KG Premium Mix Dry Fruits Combo – Almonds, Cashews, Pistachios, Walnuts & Raisins</h1>
    ...
    <!-- Product Description -->
        ...
        <div class="product-desc-content" style="padding: 12px 16px; overflow: hidden; background:#fff; font-size:0.9rem; line-height:1.5;">
            Upgrade your daily snacking with this 5KG Premium Mix Dry Fruits Combo 🥜
...
💚 Pistachios – 1KG
🌰 Walnuts – 1KG
🍇 Raisins (Kishmish) – 1KG

Carefully selected for quality and freshness, these dry fruits are packed with protein, fiber, healthy fats, and essential nutrients.

Perfect for boosting energy, improving immunity, and enjoying a healthy lifestyle.

💯 Ideal for daily consumption, gifting & festive use.

🔥 Key Features (Bullet Points)

👉 Includes 5 Premium Dry Fruits
👉 1KG Each – Total 5KG Value Pack
👉 Rich in Protein & Healthy Nutrients
👉 Fresh, Crunchy & Naturally Delicious
👉 Perfect for Snacking & Gifting
👉 High Value Combo at Budget Price

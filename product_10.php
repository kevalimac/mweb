...
<script>
  fbq('track', 'ViewContent', {
      content_name: 'Mega Kitchen Combo – Atta 5KG, Sunflower Oil 5L, Ghee 1L, Salt 1KG & Sugar 1KG',
      content_ids: ['10'],
    ...
    <div class="product-gallery">
        <div class="main-image-container">
            <img id="mainImage" src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_ax3dasax3dasax3d.png?v=1774764920" alt="">
            ...
            <div class="thumbnail-list">
                                <div class="thumb-item active" onclick="updateMainImage(this, 'https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_ax3dasax3dasax3d.png?v=1774764920')">
                    <img src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_ax3dasax3dasax3d.png?v=1774764920" alt="">
                </div>
                            </div>
        </div>
            </div>
    ...
    <div class="product-info-card">
        <h1 class="product-title">Mega Kitchen Combo – Atta 5KG, Sunflower Oil 5L, Ghee 1L, Salt 1KG & Sugar 1KG</h1>
    ...
    <!-- Product Description -->
        ...
        <div class="product-desc-content" style="padding: 12px 16px; overflow: hidden; background:#fff; font-size:0.9rem; line-height:1.5;">
            Upgrade your daily cooking essentials with this Mega Kitchen Combo Pack 🛒

This value-packed combo includes:

🌾 Aashirvaad Atta – 5KG
🛢️ Fortune Sunflower Oil – 5 Litres
🧈 Amul Pure Ghee – 1 Litre
🧂 Tata Salt – 1KG
🍬 Sugar – 1KG

Carefully selected trusted products ensure taste, nutrition, and quality in every meal. Perfect for daily cooking, festive preparation, and bulk savings.

💯 Ideal for families, smart shoppers & budget buyers.

🔥 Key Features (Bullet Points)

👉 Complete Kitchen Essentials Combo
👉 Includes Atta, Oil, Ghee, Salt & Sugar

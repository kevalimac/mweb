...
<script>
  fbq('track', 'ViewContent', {
      content_name: 'Surf Excel Easy Wash 10KG Pack + FREE Comfort Fabric Conditioner 1L',
      content_ids: ['7'],
    ...
    <div class="product-gallery">
        <div class="main-image-container">
            <img id="mainImage" src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_jyteb2jyteb2jyte.png?v=1774764921" alt="">
            ...
            <div class="thumbnail-list">
                                <div class="thumb-item active" onclick="updateMainImage(this, 'https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_jyteb2jyteb2jyte.png?v=1774764921')">
                    <img src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_jyteb2jyteb2jyte.png?v=1774764921" alt="">
                </div>
                            </div>
        </div>
            </div>
    ...
    <div class="product-info-card">
        <h1 class="product-title">Surf Excel Easy Wash 10KG Pack + FREE Comfort Fabric Conditioner 1L</h1>
    ...
    <!-- Product Description -->
        ...
        <div class="product-desc-content" style="padding: 12px 16px; overflow: hidden; background:#fff; font-size:0.9rem; line-height:1.5;">
            Upgrade your laundry routine with this value-packed combo 💥

This offer includes:

🧼 Surf Excel Easy Wash Detergent Powder – 10KG
🌸 Comfort Fabric Conditioner – 1 Litre (FREE)

Designed for deep cleaning and superior stain removal, Surf Excel ensures your clothes stay fresh and spotless. The added Comfort conditioner gives your clothes extra softness and a refreshing fragrance.

💯 Perfect for families, bulk usage & smart savings.

🔥 Key Features (Bullet Points)

👉 10KG High-Quality Detergent Powder
👉 FREE 1L Comfort Fabric Conditioner
👉 Powerful Stain Removal Formula
👉 Long-Lasting Fresh Fragrance
👉 Suitable for Daily Laundry Use
👉 Budget-Friendly Combo Deal
👉 Easy Replacement Available        </div>
    </div>

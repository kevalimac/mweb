...
<script>
  fbq('track', 'ViewContent', {
      content_name: 'Essential Grocery Combo – Besan (5KG), Atta 5KG, Moong Dal 1KG, Oil 1L & Sugar 1KG',
      content_ids: ['16'],
    ...
    <div class="product-gallery">
        <div class="main-image-container">
            <img id="mainImage" src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/ChatGPT_Image_Mar_18_2026_09_49_55_PM.png?v=1774764863" alt="">
            ...
            <div class="thumbnail-list">
                                <div class="thumb-item active" onclick="updateMainImage(this, 'https://cdn.shopify.com/s/files/1/0728/8487/9496/files/ChatGPT_Image_Mar_18_2026_09_49_55_PM.png?v=1774764863')">
                    <img src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/ChatGPT_Image_Mar_18_2026_09_49_55_PM.png?v=1774764863" alt="">
                </div>
                            </div>
        </div>
            </div>
    ...
    <div class="product-info-card">
        <h1 class="product-title">Essential Grocery Combo – Besan (5KG), Atta 5KG, Moong Dal 1KG, Oil 1L & Sugar 1KG</h1>
    ...
    <!-- Product Description -->
        ...
        <div class="product-desc-content" style="padding: 12px 16px; overflow: hidden; background:#fff; font-size:0.9rem; line-height:1.5;">
            Simplify your grocery shopping with this 5 Essential Grocery Combo Pack 🍽️

This combo includes:

🟡 Tata Besan – 1KG (Pack of 5)
🌾 Aashirvaad Chakki Atta – 5KG
🌱 Moong Dal – 1KG
🛢️ Kachi Ghani Oil – 1 Litre
🍬 Sugar – 1KG

Perfect for everyday cooking, this combo offers quality, nutrition, and value in one package. Whether it’s making rotis, snacks, or healthy meals, you get all essentials in one deal.

💯 Ideal for families, daily use & budget-friendly shopping.

🔥 Key Features (Bullet Points)

👉 5 Essential Grocery Items in One Pack
👉 Includes Besan, Atta, Dal, Oil & Sugar
👉 High Quality & Trusted Products
👉 Perfect for Daily Cooking Needs
👉 Balanced Combo for Every Kitchen

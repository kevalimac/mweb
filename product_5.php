...
<script>
  fbq('track', 'ViewContent', {
      content_name: 'Grocery Essentials Combo – 10KG Rice, 10KG Atta & 5L Kachi Ghani Mustard Oil',
      content_ids: ['5'],
    ...
    <div class="product-gallery">
        <div class="main-image-container">
            <img id="mainImage" src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_oyjekioyjekioyje.png?v=1774764922" alt="">
            ...
            <div class="thumbnail-list">
                                <div class="thumb-item active" onclick="updateMainImage(this, 'https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_oyjekioyjekioyje.png?v=1774764922')">
                    <img src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_oyjekioyjekioyje.png?v=1774764922" alt="">
                </div>
                            </div>
        </div>
            </div>
    ...
    <div class="product-info-card">
        <h1 class="product-title">Grocery Essentials Combo – 10KG Rice, 10KG Atta & 5L Kachi Ghani Mustard Oil</h1>
    ...
    <!-- Product Description -->
        ...
        <div class="product-desc-content" style="padding: 12px 16px; overflow: hidden; background:#fff; font-size:0.9rem; line-height:1.5;">
            Upgrade your kitchen with this Grocery Essentials Combo designed for everyday needs 🍽️

This combo includes:

🍚 Rozana Mini Mogra Rice – 10KG
🌾 Chakki Fresh Atta – 10KG
🛢️ Kachi Ghani Mustard Oil – 5 Litres

Perfect for daily cooking, this combo offers high quality, freshness, and huge savings in one purchase. Ideal for families looking to stock up and save money without compromising on quality.

💯 Best for monthly ration, bulk buying & smart savings.

🔥 Key Features (Bullet Points)

👉 Complete Daily Grocery Combo
👉 Includes Rice, Atta & Cooking Oil
👉 Premium Quality & Fresh Products
👉 Perfect for Family Use
👉 Bulk Pack – Value for Money
👉 Save Up to 50% OFF

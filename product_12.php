...
<script>
  fbq('track', 'ViewContent', {
      content_name: 'Beverage & Grocery Combo – Tata Tea 1.5KG, Sugar 5KG, Coffee, Green Tea & Masala Tea',
      content_ids: ['12'],
    ...
    <div class="product-gallery">
        <div class="main-image-container">
            <img id="mainImage" src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_tjjtxctjjtxctjjt.png?v=1774764920" alt="">
            ...
            <div class="thumbnail-list">
                                <div class="thumb-item active" onclick="updateMainImage(this, 'https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_tjjtxctjjtxctjjt.png?v=1774764920')">
                    <img src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_tjjtxctjjtxctjjt.png?v=1774764920" alt="">
                </div>
                            </div>
        </div>
            </div>
    ...
    <div class="product-info-card">
        <h1 class="product-title">Beverage & Grocery Combo – Tata Tea 1.5KG, Sugar 5KG, Coffee, Green Tea & Masala Tea</h1>
    ...
    <!-- Product Description -->
        ...
        <div class="product-desc-content" style="padding: 12px 16px; overflow: hidden; background:#fff; font-size:0.9rem; line-height:1.5;">
            Upgrade your daily routine with this Limited Time Beverage & Grocery Combo 🎉

This combo includes:

🍵 Tata Tea Premium – 1.5KG
🍬 Fortune Sugar – 5KG
☕ Nescafé Instant Coffee
🌿 Lipton Green Tea
🍃 Premium Spiced Tea (Masala Tea)

Perfect for every household, this combo gives you the best of taste, freshness, and energy in one powerful deal. Whether it’s your morning chai, evening coffee, or healthy green tea – everything is covered.

💯 Ideal for families, tea lovers & smart shoppers.

🔥 Key Features (Bullet Points)

👉 Complete Tea & Coffee Combo
👉 Includes Tea, Coffee, Sugar & Green Tea
👉 Premium Quality & Trusted Brands

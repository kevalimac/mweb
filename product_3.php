...
<script>
  fbq('track', 'ViewContent', {
      content_name: 'Daily Essentials Mega Saver Combo – Atta 10KG, Basmati Rice 5KG, Sugar 5KG & Soya Oil 5L',
      content_ids: ['3'],
    ...
    <div class="product-gallery">
        <div class="main-image-container">
            <img id="mainImage" src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_b7k5xsb7k5xsb7k5.png?v=1774764917" alt="">
            ...
            <div class="thumbnail-list">
                                <div class="thumb-item active" onclick="updateMainImage(this, 'https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_b7k5xsb7k5xsb7k5.png?v=1774764917')">
                    <img src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/Gemini_Generated_Image_b7k5xsb7k5xsb7k5.png?v=1774764917" alt="">
                </div>
                            </div>
        </div>
            </div>
    ...
    <div class="product-info-card">
        <h1 class="product-title">Daily Essentials Mega Saver Combo – Atta 10KG, Basmati Rice 5KG, Sugar 5KG & Soya Oil 5L</h1>
    ...
    <!-- Product Description -->
        ...
        <div class="product-desc-content" style="padding: 12px 16px; overflow: hidden; background:#fff; font-size:0.9rem; line-height:1.5;">
            Make your kitchen fully stocked with this Daily Essentials Mega Saver Combo 🛒

This combo includes trusted and high-demand grocery staples:

🌾 Aashirvaad Atta – 10KG
🍚 India Gate Rozana Basmati Rice – 5KG
🍬 Madhur Sugar – 5KG
🛢️ Fortune Soya Oil – 5 Litres

Carefully selected brands ensure quality, purity, and great taste in every meal. Whether it’s daily cooking or monthly stocking, this combo gives you maximum value at minimum cost.

💯 Perfect for families, bulk buyers & smart savers.

🔥 Key Features (Bullet Points)

👉 Complete Monthly Grocery Pack
👉 Includes Atta, Rice, Sugar & Cooking Oil
👉 Trusted & Popular Brands
👉 High Quality & Fresh Products
👉 Huge Savings – Up to 70% OFF
👉 Perfect for Home & Family Use

...
<script>
  fbq('track', 'ViewContent', {
      content_name: 'Mega Home Care Combo – Ariel 5KG, Washing Liquid, Toilet Cleaner (2x), Soaps & Dove Shampoo 1L',
      content_ids: ['13'],
    ...
    <div class="product-gallery">
        <div class="main-image-container">
            <img id="mainImage" src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/ChatGPT_Image_Mar_18_2026_09_43_30_PM.png?v=1774764860" alt="">
            ...
            <div class="thumbnail-list">
                                <div class="thumb-item active" onclick="updateMainImage(this, 'https://cdn.shopify.com/s/files/1/0728/8487/9496/files/ChatGPT_Image_Mar_18_2026_09_43_30_PM.png?v=1774764860')">
                    <img src="https://cdn.shopify.com/s/files/1/0728/8487/9496/files/ChatGPT_Image_Mar_18_2026_09_43_30_PM.png?v=1774764860" alt="">
                </div>
                            </div>
        </div>
            </div>
    ...
    <div class="product-info-card">
        <h1 class="product-title">Mega Home Care Combo – Ariel 5KG, Washing Liquid, Toilet Cleaner (2x), Soaps & Dove Shampoo 1L</h1>
    ...
    <!-- Product Description -->
        ...
        <div class="product-desc-content" style="padding: 12px 16px; overflow: hidden; background:#fff; font-size:0.9rem; line-height:1.5;">
            Upgrade your daily essentials with this All-in-One Home Care Combo 🏠💥

This value-packed combo includes:

🧼 Ariel Washing Powder – 5KG
🧴 Ariel Washing Liquid
🚽 Toilet Cleaner – 1L (Pack of 2)
🧽 Magic Soaps – Pack of 3 (300g each)
🧴 Dove Shampoo – 1 Litre

Designed for complete home hygiene and personal care, this combo ensures deep cleaning, freshness, and care for your clothes, home, and body.

💯 Perfect for families, bulk buyers & smart savers.

🔥 Key Features (Bullet Points)

👉 Complete Home & Personal Care Combo
👉 Includes Detergent, Cleaner, Soap & Shampoo
👉 Powerful Cleaning & Hygiene Protection
